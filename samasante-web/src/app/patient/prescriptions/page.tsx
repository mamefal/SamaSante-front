...
import { Search, FileText, Download, Eye, Calendar, User, Stethoscope, AlertCircle, Pill } from "lucide-react"
...
export default function PrescriptionsPage() {
    ...
    // This useEffect would typically fetch data from an API
    useEffect(() => {
            ...
            const dummyPrescriptions: Prescription[] = [
                {
                    ...
                    notes: "Reposez-vous bien et buvez beaucoup de liquides.",
                    createdAt: "2023-10-26T10:00:00Z",
                    validUntil: "2024-04-26T10:00:00Z",
                    doctor: { firstName: "Alice", lastName: "Dubois", specialty: "Médecine Générale" },
                    patient: { firstName: "Jean", lastName: "Dupont" },
                    medications: [
                        { medicationName: "Paracétamol", dosage: "500mg", frequency: "3 fois par jour", duration: "5 jours", instructions: "Prendre avec un grand verre d'eau." },
                        { medicationName: "Sirop Toux", dosage: "10ml", frequency: "2 fois par jour", duration: "7 jours" },
                    ],
                },
                {
                    id: 2,
                    ...
                    doctor: { firstName: "Bernard", lastName: "Lefevre", specialty: "ORL" },
                    patient: { firstName: "Jean", lastName: "Dupont" },
                    medications: [
                        { medicationName: "Amoxicilline", dosage: "1g", frequency: "2 fois par jour", duration: "10 jours", instructions: "À prendre au début des repas." },
                        { medicationName: "Ibuprofène", dosage: "400mg", frequency: "2 fois par jour", duration: "3 jours", instructions: "En cas de douleur ou fièvre." },
                        { medicationName: "Pastilles gorge", dosage: "1 pastille", frequency: "4 fois par jour", duration: "5 jours" },
                        { medicationName: "Spray nasal", dosage: "2 pulvérisations", frequency: "3 fois par jour", duration: "7 jours" },
                    ],
                },
                {
                    id: 3,
                    diagnosis: "Contrôle annuel",
                    notes: "Tout est en ordre, continuez vos bonnes habitudes.",
    ...
    const filteredPrescriptions = prescriptions.filter(p =>
        ...
        p.doctor.firstName.toLowerCase().includes(searchQuery.toLowerCase()) ||
        p.doctor.lastName.toLowerCase().includes(searchQuery.toLowerCase()) ||
        p.medications.some(m => m.medicationName.toLowerCase().includes(searchQuery.toLowerCase()))
    )
