...
const navigation: NavItem[] = [
    { name: "Tableau de bord", href: "/patient", icon: LayoutDashboard },
    { name: "Rendez-vous", href: "/patient/appointments", icon: Calendar },
    { name: "Dossier médical", href: "/patient/medical-record", icon: FileText },
    { name: "Profil", href: "/patient/profile", icon: User },
    { name: "Paramètres", href: "/patient/settings", icon: Settings },
]
