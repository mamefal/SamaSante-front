...
const navigation: NavItem[] = [
    { name: "Tableau de bord", href: "/hospital/dashboard", icon: LayoutDashboard },
    { name: "Patients", href: "/hospital/patients", icon: Users },
    { name: "Rendez-vous", href: "/hospital/appointments", icon: Calendar },
    { name: "Médecins", href: "/hospital/doctors", icon: UserCog },
    { name: "Départements", href: "/hospital/departments", icon: Building2 },
    { name: "Urgences", href: "/hospital/emergencies", icon: Ambulance },
    { name: "Hospitalisations", href: "/hospital/admissions", icon: Bed },
    { name: "Consultations", href: "/hospital/consultations", icon: Stethoscope },
    { name: "Ordonnances", href: "/hospital/prescriptions", icon: FileText },
    { name: "Analyses", href: "/hospital/lab-orders", icon: FlaskConical },
    { name: "Rapports", href: "/hospital/reports", icon: ClipboardList },
    { name: "Paramètres", href: "/hospital/settings", icon: Settings },
]
